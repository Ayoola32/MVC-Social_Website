      ...
      <i class="h2 mb-1 bi bi-brilliance" ></i>
        ...
        <div class="dropdown text-end">
          <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="<?=get_image(user("user_image"))?>" alt="mdo" width="32" height="32" class="rounded-circle">
          </a>
          <ul class="dropdown-menu text-small">
            <li><a class="dropdown-item" href="<?=ROOT?>/profile">My Account</a></li>
            <li><a class="dropdown-item" href="<?=ROOT?>/settings">Edit Profile</a></li>
